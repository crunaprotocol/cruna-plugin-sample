...
import {CrunaService} from "@cruna/protocol/services/CrunaService.sol";

//import "hardhat/console.sol";

contract FungibleUnmanagedService is CrunaService, Initializable, ERC20Upgradeable, ERC20PermitUpgradeable {
  ...
  function _nameId() internal view virtual override returns (bytes4) {
    return bytes4(keccak256("FungibleUnmanagedService"));
  }
